...
Avec les équations \{\#eq:eq1\}, \{\#eq:eq2\}, \{\#eq:eq3\},
\{\#eq:eq4\} faisant référence respectivement au nombre de personnes
...
Les équations \{\#eq:eq5\}, \{\#eq:eq6\}, \{\#eq:eq7\} font quant à elle
